...
def action(fh, *raw_args):
    ...
    try:
        ...
        args = [
            resolve_action_arg(arg) if not arg.startswith("-") else arg
            for arg in args
        ]
